...
export const getServerSideProps: GetServerSideProps<DebateProps> = async context => {
        ...
        <Container fluid="lg" className="mt-4 mb-5" >
            ...
            <Col>
              <Card bg="light" className="shadow-sm">
                <Card.Body>
                  ...
                  <Card.Text className="pb-2">사회 <small>OOO선생님</small></Card.Text>
          ...
          <Row className="mt-5" style={{ fontFamily: 'NanumBarunGothic' }}>
            <Col className="d-flex w-100">
              <div className="rounded-circle mr-2 mt-2" style={{ width: 36, height: 36, backgroundColor: '#0000ff' }} />
              <Card className="w-100 shadow-sm">
                <Card.Header className="d-flex align-items-center">
                  <Card.Text className="h6 font-weight-bold mb-0">김OO</Card.Text>
                  <small className="ml-auto text-muted">하루 전</small>
                </Card.Header>
                <Card.Body className="pt-3">
                  <Card.Text>저는 오늘날 사회 문제 중 코로나19로 인한 피해가 가장 크다고 생각합니다.</Card.Text>
                </Card.Body>
              </Card>
            </Col>
          </Row>
            ...
            <Col>
              <Card>
                <Card.Body className="p-2">
                  <FormControl as={TextareaAutosize} type="text" placeholder="이곳에 의견을 입력합니다" minRows={4} maxRows={12} style={{ fontFamily: 'NanumBarunGothic', borderColor: '#efefef' }} />
                </Card.Body>
