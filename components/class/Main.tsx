...
const Main: React.FC<{ classId: string }> = ({ classId }) => {
  return (
        ...
        <Col xs={12} md={8} className="mb-4">
          <Card border="light" className="shadow">
            ...
            <ListGroup variant="flush">
              <ListGroup.Item action className="d-flex justify-content-between align-items-center px-3 py-2">
                <div>
                  독후감 작성하기
              ...
              <ListGroup.Item action className="d-flex justify-content-between align-items-center px-3 py-2">
                ...
                <small className="text-danger font-weight-bold">20분 남음!</small>
              </ListGroup.Item>
