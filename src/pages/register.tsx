  ...
  return (
    <Layout>
      <Container
        fluid="sm"
        className="my-5"
        style={{ maxWidth: 900, minHeight: '70vh' }}
      >
        ...
        <Form noValidate>
          <Row>
            ...
            <Col xs="auto" className="pl-0">
              <Button
                variant="secondary"
                disabled={checkedDuplicate === false || !userId}
                onClick={async () => {
                  console.log({
                    userId,
                    name,
                  ...
                  let v = (await axios
                    .get(`${api}/auth/check-duplicate?user_id=${userId}`)
                    .then((r) => r.data.isDuplicate)) as boolean;
